jQuery(function ($) {
    ...
    (function(){
        // Tambahkan tombol WhatsApp ke dalam body
        $('body').append('<div id="toWhatsApp" class="btn btn-primary"><i class="fab fa-whatsapp"></i></div>');
        ...
        // Saat tombol diklik, arahkan ke WhatsApp
        $('#toWhatsApp').on('click', function(){
            window.location.href = "https://wa.me/6285293948420";
        });
